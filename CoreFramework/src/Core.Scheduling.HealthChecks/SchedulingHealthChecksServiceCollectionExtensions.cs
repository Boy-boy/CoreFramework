...
{
    /// <summary>
    /// Core.Scheduling.HealthChecks 依赖注入扩展。
    /// </summary>
    public static class SchedulingHealthChecksServiceCollectionExtensions
    {
        ...
        /// <summary>
        /// 注册调度健康检查。底层调用 <see cref="HealthChecksBuilderAddCheckExtensions.AddCheck{T}"/>,
        /// 并把 <see cref="SchedulingHealthCheck"/> 串到 IHealthChecksBuilder 上。
        /// 业务侧仍可链式追加 <c>AddCheck&lt;Other&gt;(...)</c>。
        /// </summary>
